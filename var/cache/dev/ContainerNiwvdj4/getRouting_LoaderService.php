...
$f->addLoader(new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($a, $d, true, array('json' => false, 'xml' => false, 'html' => true), 'json'));
$f->addLoader(new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($a, $d, true, array('json' => false, 'xml' => false, 'html' => true), 'json'));
$f->addLoader($e);
