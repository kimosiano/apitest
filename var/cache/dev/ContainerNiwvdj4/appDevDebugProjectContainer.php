...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            'appbundle\\controller\\adherentcontroller' => 'AppBundle\\Controller\\AdherentController',
            ...
            'nelmio\\apidocbundle\\form\\extension\\documentationextension' => 'Nelmio\\ApiDocBundle\\Form\\Extension\\DocumentationExtension',
        ...
        $this->fileMap = array(
            'AppBundle\\Controller\\AdherentController' => 'getAdherentControllerService.php',
            ...
            'Nelmio\\ApiDocBundle\\Form\\Extension\\DocumentationExtension' => 'getDocumentationExtensionService.php',
            'Symfony\\Bundle\\FrameworkBundle\\Controller\\RedirectController' => 'getRedirectControllerService.php',
            'Symfony\\Bundle\\FrameworkBundle\\Controller\\TemplateController' => 'getTemplateControllerService.php',
            'adherent_service' => 'getAdherentServiceService.php',
            ...
            'jms_serializer.metadata_factory' => 'getJmsSerializer_MetadataFactoryService.php',
            ...
            'nelmio_api_doc.controller_reflector' => 'getNelmioApiDoc_ControllerReflectorService.php',
            'nelmio_api_doc.describers.config' => 'getNelmioApiDoc_Describers_ConfigService.php',
            'nelmio_api_doc.describers.default' => 'getNelmioApiDoc_Describers_DefaultService.php',
            'nelmio_api_doc.describers.route.default' => 'getNelmioApiDoc_Describers_Route_DefaultService.php',
            'nelmio_api_doc.describers.swagger_php.default' => 'getNelmioApiDoc_Describers_SwaggerPhp_DefaultService.php',
            'nelmio_api_doc.generator' => 'getNelmioApiDoc_GeneratorService.php',
            'nelmio_api_doc.generator_locator' => 'getNelmioApiDoc_GeneratorLocatorService.php',
            'nelmio_api_doc.model_describers.form' => 'getNelmioApiDoc_ModelDescribers_FormService.php',
            'nelmio_api_doc.model_describers.jms' => 'getNelmioApiDoc_ModelDescribers_JmsService.php',
            'nelmio_api_doc.model_describers.object' => 'getNelmioApiDoc_ModelDescribers_ObjectService.php',
            'nelmio_api_doc.route_describers.fos_rest' => 'getNelmioApiDoc_RouteDescribers_FosRestService.php',
            'nelmio_api_doc.route_describers.php_doc' => 'getNelmioApiDoc_RouteDescribers_PhpDocService.php',
            'nelmio_api_doc.route_describers.route_metadata' => 'getNelmioApiDoc_RouteDescribers_RouteMetadataService.php',
            'nelmio_api_doc.routes.default' => 'getNelmioApiDoc_Routes_DefaultService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('7Q4rd0et0L', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Zvn9wQaLqQ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lJD4xeM61-', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mmw3CX+Ddw', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getFosRest_FormatNegotiatorService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'json', 1 => 'xml'), 'fallback_format' => 'json', 'prefer_extension' => '2.0', 'methods' => NULL, 'attributes' => array(), 'stop' => false));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\nelmio\\api-doc-bundle/Resources/views'), 'NelmioApiDoc');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\nelmio\\api-doc-bundle/Resources/views'), '!NelmioApiDoc');
