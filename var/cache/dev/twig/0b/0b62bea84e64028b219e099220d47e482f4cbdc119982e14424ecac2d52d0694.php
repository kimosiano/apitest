...
class __TwigTemplate_f9514b8c260ddf18b33f5a4e9c236f2e61dca244d031962398af7acb0dcd29c6 extends Twig_Template
{
    private $source;
        ...
        <table>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                ...
                echo "</th>
                    <td class=\"font-normal\">";
                // line 270
                echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), array($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new Twig_Error_Runtime('Variable "collector" does not exist.', 270, $this->source); })()), "bundles", array()), $context["name"], array(), "array")));
                echo "</td>
                </tr>
                ";
            }
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/config.html.twig", "C:\\wamp\\www\\api_adherents\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle\\Resources\\views\\Collector\\config.html.twig");
    }
}
